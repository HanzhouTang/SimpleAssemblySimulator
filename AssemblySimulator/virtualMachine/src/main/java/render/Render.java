...
public class Render {
    ...
    public static class ReservationStationEntryWrapper {
        ...
        public ReservationStationEntryWrapper(ReservationStation.ReservationStationEntry entry, int i) {
            index = i;
            if (entry != null) {
                instruction = entry.getInstruction() == null ? "N/A" : entry.getInstruction().toString();
    ...
    //public void ReversedTableToHtml()

    public void ReorderVirtualMachineToHtml(VirtualMachine virtualMachine, String title) throws Exception {
